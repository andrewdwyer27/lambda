            ...
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <div className="text-center">
                    <button
                        ...
                        className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-[#4B2E83] hover:bg-[#5d3da0] text-white font-semibold text-lg transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    >
